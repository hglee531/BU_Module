...
ENDTYPE
INTEGER, PARAMETER :: MaxRank = 200          !Maximum rank of Matrix
!INTEGER, PARAMETER :: MaxOrder = 100          !Maximum order of Sub Space
INTEGER, PARAMETER :: MaxOrder = 200          !Maximum order of Sub Space  !--- BYS edit 16/01/04
CONTAINS
